...
ScrollReveal().reveal('.landing-content', { delay: 200, distance: '50px', origin: 'right', duration: 1000 });
ScrollReveal().reveal('.title-section', { delay: 400, distance: '50px', origin: 'left', duration: 1000 });
ScrollReveal().reveal('.your-trip-text', { delay: 700, distance: '50px', origin: 'bottom', duration: 1000 });
